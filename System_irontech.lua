...
--// =========================================
    local INTERNAL_CONFIG = {
        Links = {
            ...
            ["https://snet.blog/w8otovu"] = "KEY-ALFA-7X-2-B-Z9M4Q",
            ["https://snet.blog/qu35nv1"] = "KEY-BETA-3Y-5-C-X7K2V",
            ["https://snet.blog/9v32nal"] = "KEY-GAMA-9Z-8-D-L3P5W",
            ["https://snet.blog/jlnznuh"] = "KEY-DELTA-4W-1-E-M8R7T",
            ["https://snet.blog/akg7v3w"] = "KEY-OMEGA-6V-3-F-N2S9Y",
        },
